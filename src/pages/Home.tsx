...
const quickActions = [
  { title: "کارگزاری بانک ملت", subtitle: "واریز و برداشت مانده وجه نقد کارگزاری....", link: "/insurance" },
  { title: "کارت هدیه سازمانی", subtitle: "برداشت 50,000,000 میلیون تومان در لحظه", link: "" },
  { title: "گردش حساب", subtitle: "واریز سود ماهانه ، واریز و برداشت ها ...", link: "" },
  { title: "گزارش‌ درخواست ها", subtitle: "تاریخچه درخواست‌‌های صدور و ابطال ...", link: "" },
];
