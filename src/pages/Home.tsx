...
const quickActions = [
  {
    ...
    subtitle: "واریز و برداشت مانده وجه نقد کارگزاری....",
    link: "/insurance",
  },
  {
    title: "کارت هدیه سازمانی",
    subtitle: "برداشت 50,000,000 میلیون تومان در لحظه",
    link: "",
  },
  {
    title: "گردش حساب",
    subtitle: "واریز سود ماهانه ، واریز و برداشت ها ...",
    link: "",
  },
  {
    title: "گزارش‌ درخواست ها",
    subtitle: "تاریخچه درخواست‌‌های صدور و ابطال ...",
    link: "",
  },
];
...
const transactions = [
  ...
  {
    amount: "‎−۱۷۲٬۰۰۰٬۰۰۰ ریال",
    amountColor: "#fb2c36",
    iconBg: "#fef2f2",
    isPlus: false,
    action: "ابطال - 10 واحد",
    date: "۱۴۰۳/۱۰/۱۵",
  },
  {
    amount: "۴۴۵٬۰۰۰٬۰۰۰ ریال",
  ...
  return (
    <Box
      sx={{
        ...
        width: "100%",
        background:
          "linear-gradient(90deg, #f26822 0%, #f89521 31%, #f89521 64%, #fbb042 100%)",
        flexShrink: 0,
      }}
    />
  );
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Typography sx={{ fontSize: 14, color: c.lightGray }}>
      ...
      <Collapse in={open}>
        ...
        >
          <Box sx={{ flex: 1 }}>
            ...
            >
              {["صندوق", "درصد دارایی", "تعداد واحد", "ارزش دارایی (ریال)"].map(
                (h) => (
                  <Typography key={h} sx={{ fontSize: 12, color: "#9599a7" }}>
                    {h}
                  </Typography>
                ),
              )}
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  />
                  <Typography sx={{ fontSize: 12, color: "#26272e" }}>
                    {row.name}
                  </Typography>
                </Box>
                <Typography
                ...
                <Typography sx={{ fontSize: 14, color: "#26272e" }}>
                  {row.units}
                </Typography>
                <Typography
                  sx={{ fontSize: 14, fontWeight: 700, color: "#26272e" }}
                >
                  {row.value}
                </Typography>
              </Box>
...
function PortfolioPie() {
  ...
  return (
    <Box sx={{ position: "relative", width: 132, height: 132, flexShrink: 0 }}>
      ...
      >
        <Typography sx={{ fontSize: 11, color: "#747474", lineHeight: 1.5 }}>
          ترکیب دارایی
        </Typography>
        <Typography sx={{ fontSize: 11, color: "#747474", lineHeight: 1.5 }}>
          در 4 صندوق
...
function StatCell({
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ fontSize: 11, fontWeight: 700, color: valueColor }}>
        {value}
      </Typography>
    </Box>
  );
    ...
    <Box sx={{ position: "relative", flexShrink: 0, width: 316 }}>
      ...
      <Box
        sx={{
          ...
          borderRadius: "22px",
          background:
            "radial-gradient(ellipse at 20% 50%, #fff 26%, #efdbb7 100%)",
        }}
      />
      {/* White card */}
      <Card
        ...
        {transactions.map((tx, i) => (
          ...
          >
            ...
            <Box sx={{ textAlign: "left" }}>
              <Typography
                sx={{ fontSize: 12, fontWeight: 500, color: "#1d293d" }}
              >
                {tx.action}
              </Typography>
              <Typography sx={{ fontSize: 12, color: "#90a1b9" }}>
                {tx.date}
              </Typography>
            </Box>
